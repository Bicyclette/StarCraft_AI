...
// 
//--------------------
class BT_DECO_CONDITION_BUILD_PROBE : public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_BUILD_PROBE(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool doBuildProbe(void* data);
