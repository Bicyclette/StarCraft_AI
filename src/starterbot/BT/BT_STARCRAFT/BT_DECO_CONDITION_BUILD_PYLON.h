...
// 
//--------------------
class BT_DECO_CONDITION_BUILD_PYLON : public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_BUILD_PYLON(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool doBuildPylon(void* data);
